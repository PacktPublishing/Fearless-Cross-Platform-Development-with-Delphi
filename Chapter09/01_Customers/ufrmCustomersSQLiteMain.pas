...
uses
  ...
  FMX.Controls.Presentation, udmCustomersSQLite;

type
  TfrmCustomersSQLite = class(TForm)
...
var
  frmCustomersSQLite: TfrmCustomersSQLite;

implementation

{$R *.fmx}

procedure TfrmCustomersSQLite.ListView1ItemClick(const Sender: TObject; const AItem: TListViewItem);
begin
